...
namespace DL
{
    public static class solarSystemInfo
    {
        public static Dictionary<string, Planet> info { get; }
        static solarSystemInfo()
        {
            var link = "https://firebasestorage.googleapis.com/v0/b/planets-9419d.appspot.com/o/";
            info = new Dictionary<string, Planet>();
            info.Add("Venus", new Planet()
            {
                Name = "Venus",
